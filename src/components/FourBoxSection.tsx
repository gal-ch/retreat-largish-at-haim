  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        >
          <Typography variant="h6" align="center" component="div" margin={2} color="#4f595a">
      ...
      >
        ...
        >
          <Typography variant="h6" align="center" margin={2} color="#4f595a">
        ...
        >
          <img
            src={require(`../assets/images/${imageTwo}`)}
            alt="Image 2"
            style={{
              height: '100%',
              width: '100%',
